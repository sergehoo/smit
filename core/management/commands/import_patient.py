...
def format_phone_number(contact):
    ...
    if len(contact) == 8:  # If it's only 8 digits, add the appropriate prefix
        ...
        if contact.startswith('07') or contact.startswith('08') or contact.startswith('09') or contact.startswith('49') or contact.startswith('59'):  # Orange CI number patterns
            return '07' + contact
        elif contact.startswith('45') or contact.startswith('44') or contact.startswith('46') or contact.startswith('05') or contact.startswith('06'):  # MTN CI number patterns
            return '05' + contact
        elif contact.startswith('01') or contact.startswith('02') or contact.startswith('03') or contact.startswith('41') or contact.startswith('42'):  # MOOV CI number patterns
            return '01' + contact
