    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='calendar_appointments', to='schedule.calendar')),
                ...
                ('doctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='doctor_appointments', to='core.employee')),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='event_appointments', to='schedule.event')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to='core.patient')),
                ('service', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='appointmentsservice', to='core.service')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('pending', 'En attente'), ('in_progress', 'En cours'), ('completed', 'Complété'), ('canceled', 'Annulé'), ('En Suivi', 'En Suivi')], default='pending', max_length=20, verbose_name='Statut')),
                ...
                ('antecedents_medicaux', models.ManyToManyField(blank=True, related_name='bilans_init_antecedents', to='smit.antecedentsmedicaux', verbose_name='Antécédents médicaux')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='smit.cathegorieechantillon')),
            ],
        ),
        migrations.CreateModel(
            name='Constante',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_echantillons', models.CharField(choices=[('Demande', 'Demande'), ('Validé', 'Validé'), ('Annulé', 'Annulé'), ('Prélevé', 'Prélevé')], default='Demande', max_length=20, verbose_name="Statut de l'échantillon")),
                ...
                ('resultat', models.CharField(blank=True, choices=[('Positif', 'Positif'), ('Négatif', 'Négatif'), ('Indéterminé', 'Indéterminé')], max_length=50, null=True)),
                ('date_analyse', models.DateTimeField(blank=True, null=True)),
                ('commentaire_resultat', models.TextField(blank=True, null=True)),
                ...
                ('cathegorie', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='smit.cathegorieechantillon')),
                ('consultation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='echantillon_for_consultation', to='smit.consultation')),
            ],
        ),
        migrations.CreateModel(
            name='Examen',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(db_index=True, max_length=250, unique=True, verbose_name="Nom de l'examen")),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Admis', 'Admis'), ('Sorti', 'Sorti'), ('Gueris-EXEA', 'Gueris-EXEA'), ('Transféré-TRANSF', 'Transféré-TRANSF'), ('SCAM', 'SCAM'), ('EVADE', 'EVADE'), ('DCD', 'DCD'), ('Aucun', 'Aucun')], max_length=50, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam_name', models.CharField(blank=True, max_length=50, null=True, verbose_name="nom de l'Examen")),
                ...
                ('result_value', models.IntegerField(blank=True, help_text="Résultats de l'examen en chiffre.", null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('cancellation_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='prescription_cancelled_by', to='core.employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequence', models.CharField(choices=[('Mensuel', 'Mensuel'), ('Bimestriel', 'Bimestriel'), ('Trimestriel', 'Trimestriel'), ('Semestriel', 'Semestriel')], default='Mensuel', max_length=50, verbose_name='Fréquence de suivi pharmacie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommandations_auto', models.TextField(blank=True, null=True, verbose_name='Recommandations automatiques')),
                ('stade_oms', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Stade 1'), (2, 'Stade 2'), (3, 'Stade 3'), (4, 'Stade 4')], null=True, verbose_name='Stade OMS')),
                ('presence_io', models.BooleanField(default=False, verbose_name='Infection opportuniste présente')),
                ('effets_secondaires', models.TextField(blank=True, null=True, verbose_name='Effets secondaires rapportés')),
                ('prophylaxie_cotrimoxazole', models.BooleanField(default=False, verbose_name='Prophylaxie cotrimoxazole')),
                ('difficultes_psychosociales', models.TextField(blank=True, null=True, verbose_name='Difficultés psychosociales identifiées')),
                ('soutien_familial', models.CharField(blank=True, choices=[('bon', 'Bon'), ('modere', 'Modéré'), ('faible', 'Faible'), ('absent', 'Absent')], max_length=20, null=True, verbose_name='Soutien familial')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('bilan_initial', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='suivis', to='smit.bilaninitial', verbose_name='Bilan Initial associé')),
                ('examens', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='smit.paraclinicalexam')),
                ...
                ('rdvconsultation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='suiviconsultation', to='smit.consultation', verbose_name='Rendez-vous en pharmacie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=255, unique=True)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sous_types', to='smit.typeantecedent')),
            ],
        ),
        migrations.CreateModel(
            name='TraitementARV',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('executed_at', models.DateTimeField(blank=True, null=True)),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Taken', 'Taken'), ('Missed', 'Missed'), ('Cancelled', 'Cancelled')], default='Pending', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('niveau_impact', models.CharField(blank=True, choices=[('aucun', 'Aucun'), ('faible', 'Faible'), ('modéré', 'Modéré'), ('élevé', 'Élevé')], help_text='Impact sur la santé', max_length=50, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mode_vie_creator', to='core.employee')),
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modes_de_vie_patients', to='core.patient')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(db_index=True, default='lit', max_length=100)),
                ('occuper', models.BooleanField(db_index=True, default=False)),
                ...
                ('is_out_of_service', models.BooleanField(db_index=True, default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interpretation_ia', models.TextField(blank=True, null=True, verbose_name='Interprétation IA')),
                ('organes_detectes', models.TextField(blank=True, null=True, verbose_name='Organes détectés')),
        ...
        migrations.AddField(
            ...
            name='bed',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='lit_hospy', to='smit.lithospitalisation'),
        ),
        migrations.AddField(
            model_name='hospitalization',
            name='doctor',
        ...
        migrations.CreateModel(
            name='HistoricalResultatAnalyse',
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('valeur', models.CharField(blank=True, help_text='Valeur numérique du résultat', max_length=100, null=True, verbose_name='Résultat numérique')),
                ('interpretation', models.TextField(blank=True, help_text='Commentaires et interprétation du résultat', null=True, verbose_name='Interprétation clinique')),
                ('unite', models.CharField(blank=True, help_text='Unité dans laquelle est exprimé le résultat', max_length=50, null=True, verbose_name='Unité de mesure')),
                ('valeur_reference', models.CharField(blank=True, help_text='Plage de valeurs normales', max_length=100, null=True, verbose_name='Valeurs de référence')),
                ('fichier_resultat', models.TextField(blank=True, help_text='PDF, image ou autre document contenant le résultat', max_length=100, null=True, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf'])], verbose_name='Fichier du résultat')),
                ('date_resultat', models.DateTimeField(default=django.utils.timezone.now, help_text='Date et heure de production du résultat', verbose_name="Date d'émission")),
                ('status', models.CharField(choices=[('draft', 'Brouillon'), ('pending', 'En attente de validation'), ('validated', 'Validé'), ('rejected', 'Rejeté'), ('corrected', 'Corrigé')], default='draft', help_text='État actuel du résultat', max_length=20, verbose_name='Statut')),
                ...
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('echantillon', models.ForeignKey(blank=True, db_constraint=False, help_text='Échantillon associé à ce résultat', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='smit.echantillon', verbose_name='Échantillon analysé')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('valide_par', models.ForeignKey(blank=True, db_constraint=False, help_text='Personne ayant validé ce résultat', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.employee', verbose_name='Validé par')),
            ],
            options={
                'verbose_name': "historical Résultat d'analyse",
                'verbose_name_plural': "historical Résultats d'analyse",
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('agent_collect', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.employee')),
                ('cathegorie', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='smit.cathegorieechantillon')),
                ('consultation', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='smit.consultation')),
                ('examen_demande', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='smit.examenstandard')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('patient', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.patient')),
                ('suivi', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='smit.suivi')),
                ('type', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='smit.typeechantillon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('parent', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='smit.cathegorieechantillon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('hospitalisation', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='smit.hospitalization')),
                ('type_appareil', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='smit.appareiltype')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='examenstandard',
            name='type_examen',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='smit.typebilanparaclinique', verbose_name="Type d'examen"),
        ),
        migrations.CreateModel(
            name='Evaluation',
            fields=[
        ...
        migrations.AddField(
            model_name='echantillon',
            name='type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='smit.typeechantillon'),
        ),
        migrations.CreateModel(
            name='Diagnostic',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_file', models.FileField(blank=True, db_index=True, null=True, upload_to='bilans/', verbose_name='Fichier du rapport')),
                ...
                ('hospitalisation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bilans', to='smit.hospitalization', verbose_name='hospitalisation_bilan_paraclinique')),
                ('patient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bilans', to='core.patient', verbose_name='bilanparacliniquepatient')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='bilaninitial',
            name='doctor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bilans_init_doc', to='core.employee', verbose_name='Médecin prescripteur'),
        ),
        migrations.AddField(
            model_name='bilaninitial',
            name='examens',
        ...
        migrations.AddField(
            model_name='bilaninitial',
            name='hospitalization',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bilans_init_hospi', to='smit.hospitalization', verbose_name='Hospitalisation associée'),
        ),
        migrations.AddField(
            model_name='bilaninitial',
        ...
        migrations.AddField(
            model_name='bilaninitial',
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bilans_init_patient', to='core.patient', verbose_name='Patient'),
        ),
        migrations.CreateModel(
            name='AvisMedical',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='appareil_control_creator', to='core.employee')),
                ('hospitalisation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='examens_appareils', to='smit.hospitalization')),
        ...
        migrations.AddField(
            ...
            name='hospitalisation',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hospiantecedents', to='smit.hospitalization'),
        ),
        migrations.AddField(
            model_name='antecedentsmedicaux',
            name='patient',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unite', models.CharField(blank=True, help_text='Unité dans laquelle est exprimé le résultat', max_length=50, null=True, verbose_name='Unité de mesure')),
                ('valeur_reference', models.CharField(blank=True, help_text='Plage de valeurs normales', max_length=100, null=True, verbose_name='Valeurs de référence')),
                ('fichier_resultat', models.FileField(blank=True, help_text='PDF, image ou autre document contenant le résultat', null=True, upload_to='resultats/%Y/%m/%d/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf'])], verbose_name='Fichier du résultat')),
                ('texte_extrait', models.TextField(blank=True, help_text='Contenu textuel extrait du fichier résultat', null=True, verbose_name='Texte extrait')),
                ('date_resultat', models.DateTimeField(default=django.utils.timezone.now, help_text='Date et heure de production du résultat', verbose_name="Date d'émission")),
                ('status', models.CharField(choices=[('draft', 'Brouillon'), ('pending', 'En attente de validation'), ('validated', 'Validé'), ('rejected', 'Rejeté'), ('corrected', 'Corrigé')], default='draft', help_text='État actuel du résultat', max_length=20, verbose_name='Statut')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Date de création')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Dernière modification')),
                ('echantillon', models.ForeignKey(help_text='Échantillon associé à ce résultat', on_delete=django.db.models.deletion.CASCADE, related_name='echanti_resultats', to='smit.echantillon', verbose_name='Échantillon analysé')),
                ('valide_par', models.ForeignKey(blank=True, help_text='Personne ayant validé ce résultat', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employee_valide', to='core.employee', verbose_name='Validé par')),
            ],
            options={
                'verbose_name': "Résultat d'analyse",
                'verbose_name_plural': "Résultats d'analyse",
                'ordering': ['-date_resultat'],
                'indexes': [models.Index(fields=['status'], name='smit_result_status_429f6e_idx'), models.Index(fields=['date_resultat'], name='smit_result_date_re_dc2032_idx'), models.Index(fields=['echantillon'], name='smit_result_echanti_921eea_idx')],
            },
        ),
        migrations.AddConstraint(
            model_name='resultatanalyse',
            constraint=models.UniqueConstraint(condition=models.Q(('status', 'validated')), fields=('echantillon',), name='unique_resultat_valide_par_echantillon'),
        ),
        ...
        migrations.AddIndex(
            model_name='bilaninitial',
            index=models.Index(fields=['status'], name='smit_bilani_status_5fe18b_idx'),
        ),
        migrations.AddIndex(
            model_name='bilaninitial',
            index=models.Index(fields=['priority'], name='smit_bilani_priorit_d5c8ed_idx'),
        ),
        migrations.AddIndex(
            model_name='bilaninitial',
            index=models.Index(fields=['is_critical'], name='smit_bilani_is_crit_e0b380_idx'),
        ),
    ]
