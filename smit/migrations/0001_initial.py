    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fichesuivie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='suivisfiche', to='smit.fichesuiviclinique', verbose_name='Fiche de suivi clinique')),
                ...
                ('traitement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='suivispatient', to='smit.traitementarv', verbose_name='Traitement ARV')),
            ],
            options={
