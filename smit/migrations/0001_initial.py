# Generated by Django 4.2.14 on 2025-07-20 23:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examen_demande', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='examen_demandee', to='smit.examenstandard')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='echantillon_for_patient', to='core.patient')),
                ('suivi', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='echantillon_for_suivi', to='smit.suivi')),
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='smit.typeechantillon')),
            ],
        ),
        migrations.CreateModel(
            name='Diagnostic',
