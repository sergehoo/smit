# Generated by Django 4.2.14 on 2024-08-14 00:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resultat', models.CharField(choices=[('POSITIF', 'Positif'), ('NEGATIF', 'Négatif'), ('INDETERMINE', 'Indéterminé')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('activite', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='acti_suivi', to='core.servicesubactivity')),
            ],
        ),
        migrations.CreateModel(
            name='Protocole',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Admitted', 'Admitted'), ('Discharged', 'Discharged'), ('Transferred', 'Transferred'), ('Deceased', 'Deceased')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patients_requested', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.patient', verbose_name='patients')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepted', models.BooleanField(blank=True, default=False, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('analyses', models.ManyToManyField(blank=True, to='smit.analyse', verbose_name="Type d'analyse")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examens', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patientexamens', to='smit.examen')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.patient')),
                ('services', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consultations', to='core.service')),
                ('suivi', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='suivi', to='core.service')),
                ('symptomes', models.ManyToManyField(blank=True, related_name='patientsymptomes', to='smit.symptomes')),
            ],
        ),
        migrations.CreateModel(
