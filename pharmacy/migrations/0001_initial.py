    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('Commande', 'Commandé'), ('Reçu', 'Reçu'), ('En attente', 'En attente')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('Commandé', 'Commandé'), ('Reçu', 'Reçu'), ('En attente', 'En attente')], default='Commandé', max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codebarre', models.CharField(default=pharmacy.models.generate_unique_code_barre, max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Le code-barre doit être composé de 12 chiffres.', regex='^\\d{12}$')])),
                ('nom', models.CharField(max_length=255, unique=True)),
                ...
                ('dosage_form', models.CharField(blank=True, choices=[('comprime', 'comprime'), ('sirop', 'sirop'), ('injection', 'injection'), ('gelule', 'gelule'), ('creme', 'creme'), ('pommade', 'pommade'), ('suppositoire', 'suppositoire'), ('gouttes', 'gouttes'), ('patch', 'patch'), ('inhalateur', 'inhalateur'), ('solution', 'solution'), ('suspension', 'suspension'), ('poudre', 'poudre'), ('spray', 'spray'), ('ovule', 'ovule'), ('collyre', 'collyre'), ('aérosol', 'aérosol'), ('elixir', 'elixir'), ('baume', 'baume'), ('granulé', 'granulé'), ('capsule', 'capsule')], max_length=50, null=True)),
                ('description', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=255, unique=True)),
                ('type', models.CharField(choices=[('comprime', 'comprime'), ('sirop', 'sirop'), ('injection', 'injection'), ('gelule', 'gelule'), ('creme', 'creme'), ('pommade', 'pommade'), ('suppositoire', 'suppositoire'), ('gouttes', 'gouttes'), ('patch', 'patch'), ('inhalateur', 'inhalateur'), ('solution', 'solution'), ('suspension', 'suspension'), ('poudre', 'poudre'), ('spray', 'spray'), ('ovule', 'ovule'), ('collyre', 'collyre'), ('aérosol', 'aérosol'), ('elixir', 'elixir'), ('baume', 'baume'), ('granulé', 'granulé'), ('capsule', 'capsule')], max_length=255)),
                ('description', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alertes', to='pharmacy.medicament')),
                ('pharmacie', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pharmacy.pharmacy')),
            ],
            options={
                'ordering': ['medication'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicaments', models.ManyToManyField(blank=True, to='pharmacy.medicament')),
